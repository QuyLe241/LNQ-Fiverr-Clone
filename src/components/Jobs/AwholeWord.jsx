    ...
    <div className="py-8 space-y-8">
      ...
      <div className="grid grid-cols-2 xl:grid-flow-cols-4 gap-8 py-5">
        ...
        >
          ...
          <p>
            Get results from skilled freelancers from <br /> all over the world,
        ...
        >
          ...
          <p>
            Pay per project or by the hour (Pro). <br /> Payments only get
        ...
        >
          ...
          <p>
            Filter to find the right freelancers quickly <br /> and get great
        ...
        >
          ...
          <p>
            Chat with our team to get your questions <br /> answered or resolve
            any issues with your <br /> orders.
          </p>
        </div>
      </div>
    </div>
