...
//   const tokenUser = isLoggedIn ? user.token : null;
//   const [errEmpty, setErrEmpty] = useState("");

//   const [dataReview, setDataReview] = useState({
//     maCongViec: idJob,
//     maNguoiBinhLuan: user?.user?.id || "", // Use optional chaining
//     ngayBinhLuan: new Date().toLocaleDateString("vi-VN", {
//       day: "2-digit",
//       month: "2-digit",
//       year: "numeric",
...
//     if (!isLoggedIn) {
//       handleNotification("Please login to post a review", "error");
//       return;
//     }
...
//             <a
//               href={pathDefault.login}
//               className="py-2 px-4 bg-green-600 rounded-lg text-white font-semibold hover:bg-green-500"
//             >
//               Sign In
//             </a>
//           </div>
...
const ReviewJob = () => {
  ...
  return (
    <div className="py-3 my-2">
      ...
      {/* Display reviews section - always visible */}
      <div className="content_review mt-3">
        {listReviewJob.length > 0 ? (
          <div className=" py-1 px-2 ">
            {listReviewJob.map((item, index) => {
      ...
      {/* Conditionally render the review form or login prompt */}
      {isLoggedIn ? (
        <div className="py-5 mt-2 flex justify-center">
          <form action="" onSubmit={reviewJob} className="w-4/5">
            <div className="py-3 flex justify-center">
        ...
        <div className="py-5 mt-2 flex justify-center">
          <div className="text-center p-4 border rounded-lg w-4/5">
            <p className="mb-3">Please log in to leave a review</p>
            <a
              href={pathDefault.login}
              className="py-2 px-4 bg-green-600 rounded-lg text-white font-semibold hover:bg-green-500 inline-block"
            >
              Sign In
            </a>
          </div>
